...
* **Keyboard Shortcuts**: Quickly navigate forward and backward through the video using the **Left/Right Arrow keys**, Undo with **Ctrl+Z**, and quickly accept live model tracking with **Enter**.
